/**
 * This is copy and pasted from the official Elsys Payload Decoder
 * at https://www.elsys.se/en/elsys-payload/.
 *
 * Note that Elsys (www.elsys.se) is the copyright holder here,
 * but put under "Use it as it is or remove the bugs :)" license,
 * as you can see below.
 *
 * Notable changes:
 * - ported code from ECMA script version 6 to version 5
 * - added a small wrapper around the Elsys code that
 * - implements the interface expected by the thingsHub
